...
`;const E="#112340",k="#1d2d50",A="#5ccfe6",S="#c3a6ff",C="#bae67e",T="#ffd580",O="#ffae57",j="#ef6b73",z="#a2aabc",I="#8695b799";var L=c.AH`
  /**
...
`;var mt=()=>{const{0:e,1:t}=(0,r.useState)({stars:null,forks:null});return(0,r.useEffect)((()=>{fetch("https://api.github.com/repos/bchiang7/v4").then((e=>e.json())).then((e=>{const{stargazers_count:n,forks_count:r}=e;t({stars:n,forks:r})})).catch((e=>console.error(e)))}),[]),r.createElement(dt,null,r.createElement(ft,null,r.createElement("ul",null,Ve.socialMedia&&Ve.socialMedia.map(((e,t)=>{let{name:n,url:i}=e;return r.createElement("li",{key:t},r.createElement("a",{href:i,"aria-label":n},r.createElement(He.In,{name:n})))})))),r.createElement(pt,{tabindex:"-1"}))};const ht=c.Ay.section`
  ${e=>{let{theme:t}=e;return t.mixins.flexCenter}};
  flex-direction: column;
...
`;var Lt=()=>{const e=(0,o.useStaticQuery)("3825832676"),{0:t,1:n}=(0,r.useState)(!1),i=(0,r.useRef)(null),a=(0,r.useRef)(null),s=(0,r.useRef)([]),l=(0,Xe.jt)();(0,r.useEffect)((()=>{l||(yt.A.reveal(i.current,(0,Ve.srConfig)()),yt.A.reveal(a.current,(0,Ve.srConfig)()),s.current.forEach(((e,t)=>yt.A.reveal(e,(0,Ve.srConfig)(100*t)))))}),[]);const c=e.projects.edges.filter((e=>{let{node:t}=e;return t})),u=c.slice(0,6),d=t?c:u,f=e=>{const{frontmatter:t,html:n}=e,{github:i,external:a,title:o,tech:s}=t;return r.createElement("div",{className:"project-inner"},r.createElement("header",null,r.createElement("div",{className:"project-top"},r.createElement("div",{className:"folder"},r.createElement(He.In,{name:"Folder"})),r.createElement("div",{className:"project-links"},i&&r.createElement("a",{href:i,"aria-label":"GitHub Link",target:"_blank",rel:"noreferrer"},r.createElement(He.In,{name:"GitHub"})),a&&r.createElement("a",{href:a,"aria-label":"External Link",className:"external",target:"_blank",rel:"noreferrer"},r.createElement(He.In,{name:"External"})))),r.createElement("h3",{className:"project-title"},r.createElement("a",{href:a,target:"_blank",rel:"noreferrer"},o)),r.createElement("div",{className:"project-description",dangerouslySetInnerHTML:{__html:n}})),r.createElement("footer",null,s&&r.createElement("ul",{className:"project-tech-list"},s.map(((e,t)=>r.createElement("li",{key:t},e))))))};return r.createElement(zt,null,r.createElement("h2",{ref:i},"Some Noteworthy Projects"),r.createElement(o.Link,{className:"inline-link archive-link",to:"/archive",ref:a},"view the archive"),r.createElement("ul",{className:"projects-grid"},l?r.createElement(r.Fragment,null,d&&d.map(((e,t)=>{let{node:n}=e;return r.createElement(It,{key:t},f(n))}))):r.createElement(Ye.A,{component:null},d&&d.map(((e,t)=>{let{node:n}=e;return r.createElement(Ue.A,{key:t,classNames:"fadeup",timeout:t>=6?300*(t-6):300,exit:!1},r.createElement(It,{key:t,ref:e=>s.current[t]=e,style:{transitionDelay:(t>=6?100*(t-6):0)+"ms"}},f(n)))})))),r.createElement("button",{className:"more-button",onClick:()=>n(!t)},"Show ",t?"Less":"More"))};n(5144);const Nt=c.Ay.section`
  max-width: 600px;
  margin: 0 auto 100px;
  text-align: center;
